//https://chatgpt.com/s/m_6a1e511c1f908191b22bccda76d27a10
...
{	u8 i;
	...
	原本：
     ...
     改成 x4：
		...
		VBG × 放大倍率
	*/
	//https://chatgpt.com/share/6a1e6831-af80-83a3-839e-b5e7263c4d24
	//_sadc2=0b10011010;
	_sadc2=0b10011011;							//致能PGA, 並選擇輸入為VBGREF,
...
{	u16 adr;
	...
	//adr=((u32)adr*3000)>>12;					//換算為電壓(放大1000倍) *3000mV
	adr=((u32)adr*4000)>>12;					//換算為電壓(放大1000倍) *4000mV

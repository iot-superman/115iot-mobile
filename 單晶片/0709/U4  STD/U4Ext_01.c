...
#define	pSPK	_pd6
#define	pSPKC	_pdc6							
#define M1  1000000UL								   	//1000000
const u8 TAB_Pitch[] = {		   					//Pitch Constant
			M1/(523UL*2*10),M1/(587UL*2*10),
			M1/(659UL*2*10),M1/(698UL*2*10),
			M1/(785UL*2*10),M1/(880UL*2*10),
			M1/(988UL*2*10),M1/(523UL*2*2*10),
			};

const u16 TAB_Duration[] = { 	      				//Duration Constant
			523/2,587/2,659/2,698/2,
			785/2,880/2,988/2,(523U*2)/2,
			};
void PAUSE(u8);
void main()
{	u8 i;

...
const s8* filter1="/YVTC006/dht22/#";    								//Subscribe Topic,/YVTCxxx/dht22/下所有主題，修正xxx為自己的學號
#define	SENSOR1	"/YVTC006/dht22/temp"									//感測器名稱(1),搭配IoT MQTT App設置，修正xxx為自己的學號
#define	SENSOR2	"/YVTC006/dht22/humi"									//感測器名稱(2),搭配IoT MQTT App設置，修正xxx為自己的學號
#define	SENSOR3	"/YVTC006/dht22/i"										//感測器名稱(3),搭配IoT MQTT App設置，修正xxx為自己的學號

...
#define topicT "/YVTC006/dht22/temp"    								//Publish Topic(1),搭配IoT MQTT設置，修正xxx為自己的學號
#define topicH "/YVTC006/dht22/humi"    								//Publish Topic(2),搭配IoT MQTT設置，修正xxx為自己的學號
#define topicI "/YVTC006/dht22/i"    									//Publish Topic(3),搭配IoT MQTT設置，修正xxx為自己的學號

...
class MainActivity : AppCompatActivity() {
    private lateinit var buttonText3: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textView3_Content = findViewById(R.id.textView3)
        ...
        buttonText3 = findViewById<Button>(R.id.button3)
        buttonText3.setOnClickListener {
            textView3_Content.text="${textView1_Title.text}\n${textView2_Center.text}"
